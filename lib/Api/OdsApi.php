...
class OdsApi
{
    ...
    protected function exportDatasetsCSVRequest($source, $where = null, $search = null, $rows = '10', $start = '0', $timezone = 'UTC', $include_app_metas = 'false', $delimiter = ';')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsCSV, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsCSV, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportDatasetsCSV, must be bigger than or equal to 0.');
        }
    ...
    protected function exportDatasetsJsonRequest($source, $where = null, $search = null, $rows = '10', $start = '0', $pretty = 'false', $timezone = 'UTC', $include_app_metas = 'false')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsJson, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsJson, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportDatasetsJson, must be bigger than or equal to 0.');
        }
    ...
    protected function exportDatasetsRDFRequest($source, $where = null, $search = null, $rows = '10', $start = '0', $timezone = 'UTC', $include_app_metas = 'false')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsRDF, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsRDF, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportDatasetsRDF, must be bigger than or equal to 0.');
        }
    ...
    protected function exportDatasetsRSSRequest($source, $where = null, $search = null, $rows = '10', $start = '0', $timezone = 'UTC', $include_app_metas = 'false')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsRSS, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsRSS, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportDatasetsRSS, must be bigger than or equal to 0.');
        }
    ...
    protected function exportDatasetsTTLRequest($source, $where = null, $search = null, $rows = '10', $start = '0', $timezone = 'UTC', $include_app_metas = 'false')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsTTL, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsTTL, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportDatasetsTTL, must be bigger than or equal to 0.');
        }
    ...
    protected function exportDatasetsXLSRequest($source, $where = null, $search = null, $rows = '10', $start = '0', $timezone = 'UTC', $include_app_metas = 'false')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsXLS, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportDatasetsXLS, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportDatasetsXLS, must be bigger than or equal to 0.');
        }
    ...
    protected function exportRecordsCSVRequest($source, $dataset_id, $where = null, $rows = '-1', $start = '0', $sort = null, $select = null, $timezone = 'UTC', $delimiter = ';')
    {
        ...
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportRecordsCSV, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportRecordsCSV, must be bigger than or equal to 0.');
        }
    ...
    protected function exportRecordsGEOJSONRequest($source, $dataset_id, $where = null, $search = null, $rows = '-1', $start = '0', $sort = null, $select = null, $timezone = 'UTC', $pretty = 'false')
    {
        ...
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportRecordsGEOJSON, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportRecordsGEOJSON, must be bigger than or equal to 0.');
        }
    ...
    protected function exportRecordsICALRequest($source, $dataset_id, $where = null, $search = null, $rows = '-1', $start = '0', $sort = null, $select = null, $timezone = 'UTC')
    {
        ...
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportRecordsICAL, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportRecordsICAL, must be bigger than or equal to 0.');
        }
    ...
    protected function exportRecordsJSONRequest($source, $dataset_id, $where = null, $search = null, $rows = '-1', $start = '0', $sort = null, $select = null, $pretty = 'false', $timezone = 'UTC')
    {
        ...
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportRecordsJSON, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportRecordsJSON, must be bigger than or equal to 0.');
        }
    ...
    protected function exportRecordsOV2Request($source, $dataset_id, $where = null, $search = null, $rows = '-1', $start = '0', $sort = null, $select = null, $timezone = 'UTC')
    {
        ...
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportRecordsOV2, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportRecordsOV2, must be bigger than or equal to 0.');
        }
    ...
    protected function exportRecordsSHPRequest($source, $dataset_id, $where = null, $search = null, $rows = '-1', $start = '0', $sort = null, $select = null, $timezone = 'UTC')
    {
        ...
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportRecordsSHP, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportRecordsSHP, must be bigger than or equal to 0.');
        }
    ...
    protected function exportRecordsXLSRequest($source, $dataset_id, $where = null, $search = null, $rows = '-1', $start = '0', $sort = null, $select = null, $timezone = 'UTC')
    {
        ...
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.exportRecordsXLS, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.exportRecordsXLS, must be bigger than or equal to 0.');
        }
    ...
    protected function getDatasetReusesRequest($source, $dataset_id, $start = '0', $rows = '10', $timezone = 'UTC')
    {
        ...
        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.getDatasetReuses, must be bigger than or equal to 0.');
        }

        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.getDatasetReuses, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.getDatasetReuses, must be bigger than or equal to -1.');
        }
    ...
    protected function getDatasetsRequest($source, $where = null, $search = null, $refine = null, $exclude = null, $rows = '10', $start = '0', $sort = null, $pretty = 'false', $timezone = 'UTC', $include_app_metas = 'false')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.getDatasets, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.getDatasets, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.getDatasets, must be bigger than or equal to 0.');
        }
     ...
     * Operation getPage
     *
     * @param  string $slug Page slug. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
    ...
    {
        list($response) = $this->getPageWithHttpInfo($slug);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($slug)
    {
        $returnType = 'object';
        $request = $this->getPageRequest($slug);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPageAsync($slug)
    {
        return $this->getPageAsyncWithHttpInfo($slug)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPageAsyncWithHttpInfo($slug)
    {
        $returnType = 'object';
        $request = $this->getPageRequest($slug);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPageRequest($slug)
    {
    ...
    protected function getRecordsRequest($source, $dataset_id, $where = null, $search = null, $refine = null, $exclude = null, $rows = '10', $start = '0', $sort = null, $select = null, $pretty = 'false', $timezone = 'UTC')
    {
        ...
        if ($rows !== null && $rows > 100) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.getRecords, must be smaller than or equal to 100.');
        }
        if ($rows !== null && $rows < -1) {
            throw new \InvalidArgumentException('invalid value for "$rows" when calling OdsApi.getRecords, must be bigger than or equal to -1.');
        }

        if ($start !== null && $start < 0) {
            throw new \InvalidArgumentException('invalid value for "$start" when calling OdsApi.getRecords, must be bigger than or equal to 0.');
        }
